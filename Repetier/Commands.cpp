...
void process_command(GCode *com,byte bufferedCommand)
{
  ...
  case 251:
	...
	if (extr == 0)
	{
		digitalWrite(PIN_AUX3_3,LOW);  // nozzle 1 up
		digitalWrite(PIN_AUX3_5,HIGH); // nozzle 0 down
	}
	else if (extr == 1)
	{
		digitalWrite(PIN_AUX3_5,LOW);  // nozzle 0 up
		digitalWrite(PIN_AUX3_3,HIGH);	// nozzle 1 down
	}
